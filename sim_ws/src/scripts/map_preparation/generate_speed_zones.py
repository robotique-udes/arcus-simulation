...
from utils.ui_speed_limiter import pick_speed_zones


def save_speed_zones_csv(polygons_grid, origin, resolution, height, output_no_ext):
    """
...
def run():
    ...
    print("\nOpening speed-zone editor...")
    polygons = pick_speed_zones(occupancy_grid)
    ...
    save_speed_zones_csv(polygons, origin, resolution, height, out_no_ext)
